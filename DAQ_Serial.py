...
RASPI_PROTOCOL_TO_DAQ_CMD_ID_REQ_EOG = 0x12   # EOG 데이터 요청
RASPI_PROTOCOL_TO_DAQ_CMD_ID_REQ_EMG = 0x13   # EMG 데이터 요청
RASPI_PROTOCOL_TO_DAQ_CMD_ID_REQ_GSR = 0x14   # GSR 데이터 요청
RASPI_PROTOCOL_TO_DAQ_CMD_ID_REQ_TEMPERATURE = 0x15  # 체온 데이터 요청
RASPI_PROTOCOL_TO_DAQ_CMD_ID_REQ_BP = 0x16    # 혈압 데이터 요청
RASPI_PROTOCOL_TO_DAQ_CMD_ID_REQ_SPO2 = 0x17  # 혈중 산소 데이터 요청
RASPI_PROTOCOL_TO_DAQ_CMD_ID_REQ_RESP = 0x18  # 호흡 데이터 요청
